...
<body>
    <div class="content">
        <div class="header">
            <h1>Like Everything Else, Have Prices In Restaurants on the Upper West Side Gone Up in the Last Five Years? How Much Have Prices Risen?</h1>
            <p class="subhead">Have Upper West Side restaurant price increases outpaced inflation? 
</p>
        </div>
        <div class="byline">
            <p>By <a href="https://jonathansoma.com">Jake Rosenwasser</a></p>
        </div>
        <p>With nearly everyone feeling the effects of inflation, I wanted to investigate how much prices in Upper West Side restaurants have risen in the last five years. Have price increases outpaced inflation? .</p>
        
        <p>I found that like nearly everything else, prices in Upper West Side restaurants have increased precipitously. After examining the prices of eight restaurants over the last five years, I determined that price increases in four restaurants outpaced inflation and price increases in four restaurants trailed inflation. .</p>

        <iframe title="Are Restaurant Prices Rising Faster Than Already-High Inflation? Yes, In Many Cases. " aria-label="Bar Chart" id="datawrapper-chart-MLQxw"
            src="https://datawrapper.dwcdn.net/TqAez/1/" scrolling="no" frameborder="0"
